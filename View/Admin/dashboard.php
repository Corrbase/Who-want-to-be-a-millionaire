            ...
            <div class="container-xl px-4">
                <div class="text-center">
                    ...
                    <p class="lead mb-0 text-white-50">
                        <?php
                            echo text($front, $language, 'title_info');
                        ?>
                    </p>
                </div>
            </div>
...
<!--        </div>-->
        ...
        <div class="row m-4">
            <div class="col mb-4">
                ...
                <a class="card lift h-100 " href="<?= '/' . $language ; ?>/admin/documentation">
                    <div class="card-body d-flex justify-content-center flex-column">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="me-3">
                                ...
                                <h5>
                                    <?php
                                    echo text($front, $language, 'documentation');
                                    ?>
                                </h5>
                                <div class="text-muted small">
                                    <?php
                                    echo text($front, $language, 'documentation_of_game');
                                    ?>
                                </div>
                            </div>
